...
function toggleMenu() {
  ...
  if (header?.classList.contains("deactivated"))
    header.classList.remove("deactivated");
...
function scrollToSection(e: React.MouseEvent<HTMLAnchorElement>) {
  ...
  const hash = href.includes("#")
    ? href.split("#")[1]
    : e.currentTarget && e.currentTarget.hash
    ? e.currentTarget.hash.substring(1)
    : "";
  if (!hash) return;
  ...
  if (
    headerContainer &&
    !isDesktop &&
    !headerContainer.classList.contains("deactivated")
  ) {
...
function changeMenuStyle(transparent: boolean = true) {
  const header = document.getElementById("header-container");
  ...
  return (
    <div className="w-full max-w-80ch" onScroll={checkScrollPosition}>
      <div id="header-container" className="deactivated transparent">
        <div
          id="nav-overlay"
          className="fixed w-full h-full bg-white z-[47] lg:hidden deactivated"
          onClick={toggleMenu}
        ></div>
        ...
        <header className="fixed top-0 w-full left-0 z-[48] lg:flex lg:flex-row lg:bg-white lg:justify-center lg:items-center">
          <div className="controls flex flex-row justify-between p-4 bg-white z-[50] relative">
            ...
            <MenuIcon
              className="menu-toggle text-black w-12 h-12 lg:hidden"
              onClick={toggleMenu}
            />
          </div>

          <nav id="nav" className="deactivated p-4 bg-white z-[49]">
            <ul className="flex flex-col lg:flex-row lg:space-x-4 space-y-4 lg:space-y-0 items-center justify-center mb-0 lg:text-sm">
              <li>
                <a href="#problem" onClick={scrollToSection}>
                  The Problem
                </a>
              </li>
              <li>
                <a href="#solution" onClick={scrollToSection}>
                  The Solution
                </a>
              </li>
              <li>
                <a href="#demo" onClick={scrollToSection}>
                  Demo
                </a>
              </li>
              <li>
                <a href="#privacy" onClick={scrollToSection}>
                  Privacy Deep Dive
                </a>
              </li>
              <li>
                <a href="#how" onClick={scrollToSection}>
                  How It Works
                </a>
              </li>
              <li>
                <a href="#action" onClick={scrollToSection}>
                  Signal Your Support
                </a>
              </li>
              <li>
      ...
      <main className="text-left">
        <div className="hero flex items-center justify-center w-full p-6 pt-24 min-h-screen lg:p-36 relative overflow-hidden">
          <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
            {/* Text content wrapper - we'll reorder children on mobile */}
            <div className="flex-1 text-left flex flex-col">
              {/* Title - appears first on both mobile and desktop */}
              <h1
                className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-8 animate-fade-in-up order-1"
              ...
              <div className="order-3 lg:order-2">
                <h3
                  className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-medium mb-8 max-w-2xl animate-fade-in-up animation-delay-200"
                  style={{ minHeight: "7rem" }}
                >
                  <TextScramble speed={30} delay={600}>
                    Bitcoin belongs in Signal. Cashu ecash enables truly private
                    bitcoin payments inside the world&apos;s most trusted
                    encrypted messenger.
                  </TextScramble>
                </h3>
        ...
        <div className="container mx-auto px-12 max-w-screen-xl">
          <section className="flex flex-col md:flex-row md:gap-4 md:pt-12 md:pb-12">
            <div className="w-full md:basis-6/12 space-y-4 flex justify-center flex-col">
              ...
              <div className="md:hidden mb-6 flex justify-center">
                <img
                  src="/signal-problem.jpg"
                  alt="Signal needs private bitcoin"
                  className="w-full max-w-sm object-contain"
                />
              </div>

              <h3>Payments Belong in Signal</h3>

              <p>
                Signal enables private communication for everyone. By protecting
                our freedom of speech as the world&apos;s most trusted
                messenger, Signal is the natural place for privacy-preserving
                commerce that can protect our freedom to transact with each
                other.
              </p>

              <p>
                Signal aimed to solve this problem by integrating MobileCoin, a
                speculative cryptocurrency that has failed to gain meaningful
                adoption. Today, most Signal users aren&apos;t aware that this
                feature exists.
              </p>
            </div>
            ...
            <div className="hidden md:flex md:basis-6/12 pt-6 md:p-6 justify-center">
              <img
                src="/signal-problem.jpg"
                alt="Signal needs private bitcoin"
                className="xl:w-8/12 object-contain"
              />
            </div>
          </section>
          ...
          <section className="flex flex-col md:flex-row md:gap-4 md:pt-12 md:pb-12">
            <div className="w-full md:basis-6/12 space-y-4 flex justify-center flex-col">
              ...
              <div className="md:hidden mb-6 flex justify-center">
                <img
                  src="/signal-hidden.jpg"
                  alt="Cashu x Signal integration"
                  className="w-full max-w-sm object-contain"
                />
              </div>
              ...
              <p>
                We love Signal and want to bring the best payment experience to
                the best private messenger in the world. As the most widely
                adopted cryptocurrency, Bitcoin is ideal as the backbone for the
                new global economy.
              </p>

              <p>
                Using the Cashu protocol, a Chaumian ecash system that provides
                strong privacy, Signal users can send and receive Bitcoin
                micropayments. Private messages meet private money.
              </p>
            </div>
          ...
          <div className="pt-12 pb-12 text-center space-y-8">
            ...
            <p className="max-w-4xl mx-auto">
              The Signal Cashu fork demonstrates how bitcoin payments can work
              seamlessly inside Signal.
            </p>
            ...
            <div className="flex flex-col space-y-8 pb-12">
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-center text-signal-text max-w-4xl">
                  Users can send ecash directly in their Signal conversations,
                  like handing over a physical bill to your friend.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                />
                <p className="text-center text-signal-text max-w-4xl">
                  The UI is clean and native to Signal, making bitcoin payments
                  feel as natural as sending a message.
                </p>
              </div>
            </div>
          </div>
          ...
          <section>
            <div className="basis-6/12 space-y-4 flex flex-col justify-center">
              ...
              <p>
                Signal&apos;s mission is to protect privacy. End-to-end
                encryption ensures that no one &mdash; not even Signal &mdash;
                can read your messages. Cashu extends this same principle to
                money.
              </p>

              <p>
                <strong>Chaumian ecash</strong> ensures user privacy while
                enabling instant and cheap payments, even for tiny amounts.
                Ecash is not a cryptocurrency but a representation of an asset,
                just like how physical cash represents your money. No
                speculation, no get quick rich schemes. Cashu works best with
                Bitcoin but it is compatible even with fiat currencies like USD.
              </p>

              <p>
                <strong>Blind signatures</strong> are the cryptographic
                primitive that enable cash-like privacy in the digital world.
                Introduced in the 80s by visionary cryptographer David Chaum,
                ecash is experiencing a renaissance in recent years due to
                open-source projects like Cashu.
              </p>

              <p>
                The Cashu Signal integration doesn&apos;t compromise
                Signal&apos;s privacy guarantees &mdash; it extends them to
                financial transactions. Your messages are private. Your payments
                should be too.
              </p>
            </div>
              ...
              <div className="bg-signal-bg border border-signal-border-weak p-6 rounded-md w-full max-w-md">
                ...
                <div className="text-sm text-signal-text space-y-2 font-mono bg-white p-4 rounded border">
                  ...
                  <div>
                    ...
                    and computes{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"Y = \\mathrm{hash\\_to\\_curve}(x)"} />
                    </span>
                    .
                  </div>
                  <div>
                    3. <code className="bg-gray-100 px-1 rounded">Alice</code>{" "}
                    sends to{" "}
                    <code className="bg-gray-100 px-1 rounded">Bob</code>{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"B' = Y + rG"} />
                    </span>{" "}
                    with{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"r"} />
                    </span>{" "}
                    being a random blinding factor.
                  </div>
                  <div>
                    4. <code className="bg-gray-100 px-1 rounded">Bob</code>{" "}
                    sends back to{" "}
                    <code className="bg-gray-100 px-1 rounded">Alice</code>{" "}
                    blind signature{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"C' = k \\cdot B'"} />
                    </span>
                    .
                  </div>
                  <div>
                    5. <code className="bg-gray-100 px-1 rounded">Alice</code>{" "}
                    can calculate the unblinded signature as{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"C' - rK = kY + krG - krG = kY = C"} />
                    </span>
                    .
                  </div>
                  <div>
                    6. <code className="bg-gray-100 px-1 rounded">Alice</code>{" "}
                    can take the pair{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"(x, C)"} />
                    </span>{" "}
                    as an ecash token and can send it to user{" "}
                    <code className="bg-gray-100 px-1 rounded">Carol</code>.
                  </div>
                  <div>
                    7. <code className="bg-gray-100 px-1 rounded">Carol</code>{" "}
                    sends{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath math={"(x, C)"} />
                    </span>{" "}
                    to <code className="bg-gray-100 px-1 rounded">Bob</code> who
                    then checks that{" "}
                    <span className="bg-gray-100 px-1 rounded">
                      <InlineMath
                        math={"k \\cdot \\mathrm{hash\\_to\\_curve}(x) = C"}
                      />
                    </span>
                ...
                <p className="text-xs text-signal-text-weak mt-3">
                  ...
                  <InlineMath math={"r"} /> is a blinding factor. The mint can
                  verify tokens without knowing who originally created them.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <div className="basis-6/12 space-y-4 flex flex-col justify-center">
              ...
              <p>
                <strong>The Signal Cashu integration</strong> embeds a
                lightweight Cashu wallet directly into Signal using the{" "}
                <a
                  href="https://cashudevkit.org/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Cashu Development Kit
                </a>
                . Building with Cashu is as simple as it gets so we added Cashu
                to Signal for iOS and Android. The result is a beautiful and
                intuitive user experience.
              </p>

              <p>
                <strong>Ecash is like physical cash</strong> and is stored
                locally on the user&apos;s device. To make a payment, the user
                sends ecash through the encrypted Signal chat, like any other
                text message. Nobody facilitates the payment for you, everything
                stays between you and your friends.
              </p>

              <p>
                <strong>Cashu Mints</strong> issue ecash in return for payments
                on the Bitcoin network. Users deposit Bitcoin to a mint and the
                mint acts as a trusted custodian for the Bitcoin it receives.
                Think of it like a community bank, but with strong privacy.
                Mints allow users to send and receive payments from anyone,
                anywhere, at any time. Whether its from another Signal contact,
                or a merchant that accepts Bitcoin.
              </p>

              <p>
                <strong>The Cashu protocol</strong> is open and not controlled
                by a single entity. It is defined in the Cashu{" "}
                <a
                ...
                . This means that any individual or organization can run a mint
                or create a wallet. Cashu has a vibrant{" "}
                <a
                ...
                with many wallet and mint implementations and{" "}
                <a
                  href="https://docs.cashu.space/libraries"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  developer libraries
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-signal-text space-y-1 ml-4">
                      ...
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/03/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
                      ...
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/04/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-signal-text space-y-1 ml-4">
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/11/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
                      ...
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/12/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
                      ...
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/16/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
                      ...
                      <li>
                        •{" "}
                        <a
                          href="https://cashubtc.github.io/nuts/22/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline font-medium"
                        >
        ...
        <div className="md:p-12 flex flex-col md:items-center space-y-8 p-4 mx-auto mb-8">
          ...
          <p className="max-w-screen-sm md:text-center text-xl">
            Our proof-of-concept demonstrates that Bitcoin in Signal is
            technically feasible with Cashu. If you like this idea as much as we
            do, show your support and let&apos;s spark the imagination of the
            open-source world.
          </p>
          ...
          <div className="max-w-screen-lg pt-8 space-y-6">
            <div className="bg-white border border-signal-border-weak p-8 rounded-md shadow-sm space-y-4 transition-shadow duration-300 hover:shadow-md">
              ...
              <ul className="list-disc ml-6 space-y-2 text-signal-text">
                ...
                <li>
                  Express genuine interest in private Bitcoin payments when
                  engaging with Signal
                </li>
                <li>
                  Discuss Bitcoin For Signal topic in forums, meetups, and with
                  your friends
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-signal-border-weak p-8 rounded-md shadow-sm space-y-4 transition-shadow duration-300 hover:shadow-md">
              ...
              <ul className="list-disc ml-6 space-y-2 text-signal-text">
                ...
                <li>
                  Widespread Bitcoin adoption protects user privacy better than
                  specialized cryptocurrencies
                </li>
                <li>
                  Bitcoin brings millions of potential new users, more users
          ...
          <div className="flex flex-col md:flex-row m-0 gap-8 md:gap-16">
            <div className="basis-6/12 space-y-6">
              <div>
                <h3>What is Cashu?</h3>
                <p>
                  Cashu enables private, peer-to-peer bitcoin payments using
                  Chaumian blind signatures. It&apos;s not a company,
                  organization, or entity with financial interests &mdash;
                  it&apos;s a free and open-source community-driven project with
                  no single controlling entity. Cashu allows users to send
                  bitcoin payments with the same level of privacy as physical
                  cash, while maintaining compatibility with the broader Bitcoin
                  ecosystem.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Cashu is a purely open-source project with no commercial
                  interests. It is not a speculative cryptocurrency but a
                  protocol that works with any asset. Bitcoin is internet&apos;s
                  native digital currency with the largest user base across the
                  world. Cashu brings strong privacy to bitcoin, making it a
                  pragmatic solution that Signal can build on.
                </p>
              </div>
            </div>
            <div className="basis-6/12 space-y-6">
              <div>
                ...
                <p>
                  We love and trust Signal and want to imagine a better world
                  together with them. This site and the proof-of-concept are
                  tools to spark their imagination and to show Signal that
                  there&apos;s real interest for global micropayments within
                  their ecosystem. Together with Signal, we would love to start
                  a discussion about integrating Cashu or a similar bitcoin
                  privacy solution.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Share this site, try the proof-of-concept fork. The best
                  support you can give is to use privacy-preserving technologies
                  and to share it with your friends. If you&apos;re a developer,
                  check out the Cashu protocol, consider integrating it with
                  your app, or contribute to the Cashu code or the broader Cashu
                  ecosystem directly.
                </p>
              </div>
            </div>
